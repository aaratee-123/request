...
.then(response=>{
    ...
    fs.writeFileSync("gurukul.json",myJSON)
    ...
    user_input =a.questionInt("Enter your courses number that you want to learn:- ")-1
    console.log(DATA[user_input]["name"])
    id=DATA[user_input]["id"]
    link_2="https://api.merakilearn.org/courses/"+id+"/exercises"
    axios.get(link_2)
    .then(response1=>{
        ...
        Question=a.questionInt("enter the question that you want:")
